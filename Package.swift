...
let package = Package(
    ...
    products: [
        ...
        .library(
            name: "PreparedStatementsPostgresNIO",
            targets: ["PreparedStatementsPostgresNIO"]
        ),
        .executable(
            name: "PreparedStatementsPostgresNIOClient",
            targets: ["PreparedStatementsPostgresNIOClient"]
        ),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .testTarget(
            name: "PreparedStatementsPostgresNIOTests",
            dependencies: [
                "PreparedStatementsPostgresNIOMacros",
